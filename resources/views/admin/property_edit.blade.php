...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">{{ EDIT_PROPERTY }}</h1>

    <form action="{{ route('admin_property_update',$property->id) }}" method="post" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="p1" role="tabpanel" aria-labelledby="p1_tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <img src="{{ asset('uploads/property_featured_photos/'.$property->property_featured_photo) }}" class="w_200" alt="">
                                    </div>
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin_property_delete_social_item',$row->id) }}" class="badge badge-danger fz-14 mt_5" onClick="return confirm('{{ ARE_YOU_SURE }}');">{{ DELETE }}</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </table>
                                ...
                                <div class="row">
                                    @foreach($property_photos as $row)
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div>
                                                    <img src="{{ asset('uploads/property_photos/'.$row->photo) }}" class="w_100_p" alt=""><br>
                                                    <a href="{{ route('admin_property_delete_photo',$row->id) }}" class="badge badge-danger fz-14 mt_5" onClick="return confirm('{{ ARE_YOU_SURE }}');">{{ DELETE }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                            ...
                            <div class="tab-pane fade" id="p6" role="tabpanel" aria-labelledby="p6_tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 existing-video">
                                        ...
                                        <br>
                                        <a href="{{ route('admin_property_delete_video',$row->id) }}" class="badge badge-danger fz-14 mt_5" onClick="return confirm('{{ ARE_YOU_SURE }}');">{{ DELETE }}</a>
                                    </div>
                                    @endforeach
                                </div>
