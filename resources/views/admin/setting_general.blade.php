                ...
                <div class="row">
                    <div class="col-3">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="p9_tab" data-toggle="pill" href="#p9" role="tab" aria-controls="p9" aria-selected="false">{{ CUSTOMER_PROPERTY_OPTION }}</a>
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="p1" role="tabpanel" aria-labelledby="p1_tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <img src="{{ asset('uploads/site_photos/'.$setting->logo) }}" alt="" class="h_80">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="p2" role="tabpanel" aria-labelledby="p2_tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <img src="{{ asset('uploads/site_photos/'.$setting->favicon) }}" alt="" class="h_80">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="p11" role="tabpanel" aria-labelledby="p11_tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="top_phone" class="form-control" value="{{ $setting->top_phone }}">
                                </div>

                                <div class="form-group">
                                    <label for="">{{ EMAIL }}</label>
                                    <input type="text" name="top_email" class="form-control" value="{{ $setting->top_email }}">
                                </div>
                                <!-- // Tab Content -->
                            ...
                            <div class="tab-pane fade" id="p9" role="tabpanel" aria-labelledby="p9_tab">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">{{ CUSTOMER_PROPERTY }}</label>
                                            <select name="customer_property_option" class="form-control">
                                                <option value="On" @if($setting->customer_property_option == 'On') selected @endif>{{ ON }}</option>
                                                <option value="Off" @if($setting->customer_property_option == 'Off') selected @endif>{{ OFF }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
